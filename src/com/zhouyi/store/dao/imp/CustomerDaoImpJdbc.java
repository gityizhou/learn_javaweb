...
import com.zhouyi.db.core.JdbcTemplate;
import com.zhouyi.db.core.PreparedStatementCreator;
import com.zhouyi.db.core.RowCallbackHandler;
...
public class CustomerDaoImpJdbc implements CustomerDao {
    ...
    private void getCustomerList(String pk, List<Customer> list, String sql) {
    ...
    private void popular(List<Customer> list, ResultSet rs) throws SQLException {
